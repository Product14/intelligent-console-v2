...
import { RefundFilters, RefundStatus } from '../types/refunds';
...
const refundStatusOptions: Array<{
  value: RefundStatus;
  label: string;
}> = [
...
export default function RefundFiltersComponent({
  filters,
  onFiltersChange,
  onExportCSV,
  products,
  ...
  const hasProductFilter = !!filters.product;

  // Only show reset button if there are actual filters applied (not just product filter)
  const hasActiveFilters =
    hasRaisedDateFilter || hasStatusFilter || hasProductFilter;
