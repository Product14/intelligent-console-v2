export const GUEST_DEMO_SAMPLE = {
  video:
    'https://d20uiuzezo3er4.cloudfront.net/AI-tools/ai-tool-home/video+compressed+home.mp4',
  ...
  INTERACTIVE_DEMO: {
    IMAGES: {
      ...
      ITEM_NAME:
        'console.screens.virtualStudio.commonGuest.featurePage.image.images',
      ITEM_DESCRIPTION:
        'console.screens.virtualStudio.commonGuest.featurePage.image.accelerateSale',
      BUTTON_DESCRIPTION:
        'console.screens.virtualStudio.commonGuest.featurePage.image.generateImages',
    },
    _360: {
      common_demo_360: `https://d20uiuzezo3er4.cloudfront.net/console/360_common_demo.svg`,
      ITEM_NAME:
        'console.screens.virtualStudio.commonGuest.featurePage.spin_360.360',
      ITEM_DESCRIPTION:
        'console.screens.virtualStudio.commonGuest.featurePage.spin_360.walkarounds',
      BUTTON_DESCRIPTION:
        'console.screens.virtualStudio.commonGuest.featurePage.spin_360.generate360',
    },
    VIDEO: {
      common_demo_video: `https://d20uiuzezo3er4.cloudfront.net/console/videos_common_demo.svg`,
      ITEM_NAME:
        'console.screens.virtualStudio.commonGuest.featurePage.video.videoTour',
      ITEM_DESCRIPTION:
        'console.screens.virtualStudio.commonGuest.featurePage.video.replaceBrochures',
      BUTTON_DESCRIPTION:
        'console.screens.virtualStudio.commonGuest.featurePage.video.generateVideo',
    },
  },
...
export const getSelectedVinFeatureData = (data, selectedVin) => {
  return {
    [TAB_ENUM.images]:
      data.images.find((item) => item.vin === selectedVin) || {},
    [TAB_ENUM.demo360]:
      data[TAB_ENUM.demo360].find((item) => item.vin === selectedVin) || {},
    [TAB_ENUM.video]:
      data.videotour.find((item) => item.vin === selectedVin) || {},
  };
};
  ...
  return [
    {
      ...
      data: {
        ...
        itemDescription:
          GUEST_DEMO_SAMPLE.INTERACTIVE_DEMO.IMAGES.ITEM_DESCRIPTION,
        redirectTo: TAB_ENUM.images,
        buttonDescription:
          GUEST_DEMO_SAMPLE.INTERACTIVE_DEMO.IMAGES.BUTTON_DESCRIPTION,
      },
    ...
    },
    {
      ...
      data: {
        ...
        itemDescription:
          GUEST_DEMO_SAMPLE.INTERACTIVE_DEMO._360.ITEM_DESCRIPTION,
        redirectTo: TAB_ENUM.demo360,
        buttonDescription:
          GUEST_DEMO_SAMPLE.INTERACTIVE_DEMO._360.BUTTON_DESCRIPTION,
      },
    ...
    },
    {
      ...
      data: {
        ...
        itemDescription:
          GUEST_DEMO_SAMPLE.INTERACTIVE_DEMO.VIDEO.ITEM_DESCRIPTION,
        redirectTo: TAB_ENUM.video,
        buttonDescription:
          GUEST_DEMO_SAMPLE.INTERACTIVE_DEMO.VIDEO.BUTTON_DESCRIPTION,
      },
