...
const LoginModal = (props) => {
  ...
  const continueWithGoogle = async (googleResponse) => {
    try {
      ...
      toast(translate('Oops, something went wrong! Please try again.'), {
    ...
    >
      ...
      <div className="fixed inset-0 z-20 overflow-y-auto">
        <div className="lsm:items-center lsm:p-4 flex min-h-full items-end justify-center">
          <div
            className="bottom-modal-sm lsm:max-h-fit lsm:w-8/12 lsm:rounded-xl relative flex max-h-[600px] w-full flex-col items-center gap-5 overflow-y-clip rounded-t-3xl bg-transparent p-4"
            ref={loginModalRef}
          >
            {/* <div className="mx-auto h-1.5 w-[50%] rounded-3xl bg-black-20 lg:hidden"></div> */}
            ...
            {showEmailSignup ? (
              ...
              <>
                <GuestLogin
                  ...
                  setShowLoginMenu={setShowLoginMenu}
                  allowClose={
                    props.allowClose && props.allowClose === true ? true : false
                  }
                  translate={translate}
                />
              </>
              ...
              <>
                ...
                <p className="text-black-60 text-center font-normal tracking-tight">
                  ...
                  <span
                    onClick={() => handleLogin()}
                    className="text-blue-light cursor-pointer font-medium"
                  >
                    Log&nbsp;in
                  </span>
                </p>
